...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    RBTreeNode<T> rotateRight(RBTreeNode<T> node) {
        RBTreeNode<T> leftTop = node.left;
        node.left = leftTop.right;
        leftTop.right = node;
        leftTop.isBlack = node.isBlack;
        node.isBlack = false;
        // YOUR CODE HERE
        return leftTop;
    }

   /** public RBTreeNode<T> findParent(RBTreeNode<T> node, RBTreeNode root) {
        BTree.Node current = (BTree.Node) root;
        BTree.Node peakLeft = current.getItemAt(2* current.getItemCount());
        BTree.Node peakRight =
        return parent;
    }*/
    ...
    RBTreeNode<T> rotateLeft(RBTreeNode<T> node) {
        RBTreeNode<T> rightTop = node.right;
        node.right = rightTop.left;
        rightTop.left = node;
        rightTop.isBlack = node.isBlack;
        node.isBlack = false;
        // YOUR CODE HERE
        return rightTop;
    }
