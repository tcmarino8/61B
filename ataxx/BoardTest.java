...
public class BoardTest {
    ...
    public void getLegalMoveTest() {
        ArrayList<Move> checker = new ArrayList<>();
        Board boardForCheck = new Board();
        Board startingBoard = new Board();
        makeMoves(boardForCheck, UNDO2MOVES);
        boardForCheck.getLegalMoves(boardForCheck, '2','a', checker);
        boardForCheck.getLegalMoves(boardForCheck, '3','d', checker);
        ArrayList<ArrayList<Move>> helper =
                startingBoard.getAllLegalMoves(startingBoard);
        ArrayList<ArrayList<Move>> helper2 =
                boardForCheck.getAllLegalMoves(boardForCheck);
    }*/
